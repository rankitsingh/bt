            ...
            <div className="p-7 relative">
              ...
              {submitted ? (
                ...
                <>
                  ...
                  <button onClick={async () => { await submitToSheets({ type: "Buyer", name: "Website Lead", mobile: "", email: "", source: "Website — CTA" }); setSubmitted(true); }} className={`w-full mt-5 py-4 rounded-xl font-bold text-white text-sm transition-all hover:-translate-y-0.5 hover:shadow-xl ${modal === "buyer" ? "bg-[#0D1B3E] hover:bg-[#1a2f5e]" : "bg-[#F59E0B] hover:bg-[#E58E08]"}`}>
